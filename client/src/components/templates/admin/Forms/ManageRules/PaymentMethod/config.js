...
export const initAchForm = () => {
  return {
    routingNumber: { value: "", message: "", required: true },
    accountNumber: { value: "", message: "", required: true },
    reaccountNumber: { value: "", message: "", required: true },
    financialInstitution: { value: "", message: "", required: true },
  };
};
